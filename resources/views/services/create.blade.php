                        ...
                        <form action="/services" id="form-create-services" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="input-group col-lg-6">
                                    ...
                                    <input class="form-control  @error('value') is-invalid  @enderror" placeholder="Valor" id="password" name="value">
                                    @if ($errors->has('value'))
                                    <span class="invalid-feedback">
                            ...
                            <div class="form-row">
                                <div class="input-group col-lg-6">
                                    ...
                                    <textarea class="form-control  @error('description') is-invalid  @enderror" id="description" name="description" placeholder="Descrição" style="height:80px"></textarea>
