                        ...
                        <form action="/services" id="form-create-services" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="input-group col-lg-6">
                                    ...
                                    <input class="form-control" placeholder="Valor" id="password" name="value">
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="input-group col-lg-6">
                                    ...
                                    <textarea class="form-control" id="description" name="description" placeholder="Descrição" style="height:80px"></textarea>
                                </div>
                            </div>
                            </div>
